...
{
   static var Label = {font:"_sans",embedfonts:false,align:"center",size:10,color:16777215,bold:true,italic:false};
   static var LabelBlack = {font:"_sans",embedfonts:false,align:"center",size:10,color:0,bold:true,italic:false};
   static var TextInput = {font:"_sans",embedfonts:false,align:"left",size:10,color:0,bold:true,italic:false};
   ...
   static var TextArea = {font:"Font2",embedfonts:true,align:"left",size:10,bold:false,italic:false,scrollbarstyle:"ScrollBar"};
   ...
   static var Window = {titlestyle:"Label",cornerradius:{tl:13,tr:13,br:13,bl:13},bordercolor:16777215,borderwidth:3,backgroundcolor:13421772,titlecolor:5327420,titleheight:22};
