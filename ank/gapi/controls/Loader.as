class ank.gapi.controls.Loader extends ank.gapi.core.UIBasicComponent
{
   ...
   function load()
   {
      ...
      if(this.holder_mc.content_mc == undefined)
      {
         com.ankamagames.tools.Logger.out("WG Loader : load","ank.gapi.controls.Loader::load","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/gapi/controls/Loader.as",298);
