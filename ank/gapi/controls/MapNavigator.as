class ank.gapi.controls.MapNavigator extends ank.gapi.core.UIAdvancedComponent
{
   ...
   function setMapPosition(nX, nY)
   {
      ...
      if(nX > ank.gapi.controls.MapNavigator.MAX_X)
      {
         nX = ank.gapi.controls.MapNavigator.MAX_X;
      }
      else if(nX < ank.gapi.controls.MapNavigator.MIN_X)
      {
         nX = ank.gapi.controls.MapNavigator.MIN_X;
      }
      if(nY > ank.gapi.controls.MapNavigator.MAX_Y)
      {
         nY = ank.gapi.controls.MapNavigator.MAX_Y;
      }
      else if(nY < ank.gapi.controls.MapNavigator.MIN_Y)
      {
         nY = ank.gapi.controls.MapNavigator.MIN_Y;
      }
      this.removeAreaClip();
      this._nXCurrent = nX;
      this._nYCurrent = nY;
   ...
   function addXtraClip(sLink, sLayer, nX, nY, nColor, nAlpha, bDispatchClickEvent, bDontAddIfXtra)
   {
      if(nX != 0 || nY != 0)
      {
         ...
         var _loc11_ = this._nWPage * nX + 3;
         var _loc12_ = this._nHPage * nY + 3;
   ...
   function draw()
   {
      ...
      ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcBorder,_loc2_.bordercolor);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcMapBorder,_loc2_.bordercolor);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcGrid,_loc2_.gridcolor);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcMapBackground,_loc2_.bgcolor);
   }
   function drawGrid(bZoomAccept)
   {
      ...
      if(this._bShowGrid && bZoomAccept)
      {
         ...
         while(_loc3_ > 0)
         {
            ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcGrid,_loc3_,0,1,this._nMapHeight,0,0);
         ...
         while(_loc4_ > 0)
         {
            ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcGrid,0,_loc4_,this._nMapWidth,1,0,0);
