class ank.gapi.controls.button.ButtonBackground extends ank.gapi.core.UIBasicComponent
{
   ...
   function setStyleColor(oStyle, sSuffixe)
   {
      ...
      for(var k in _loc4_)
      {
         ...
         if(_loc6_ != undefined)
         {
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc4_[k],_loc6_);
         }
      }
      ...
      for(var k in _loc4_)
      {
         ...
         if(_loc8_ != undefined)
         {
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc4_[k],_loc8_);
         }
      }
      ...
      for(var k in _loc4_)
      {
         ...
         {
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc4_[k],_loc10_);
         }
      }
   }
}
