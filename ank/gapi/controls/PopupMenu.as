class ank.gapi.controls.PopupMenu extends ank.gapi.core.UIBasicComponent
{
   ...
   function draw()
   {
      ...
      var _loc3_ = _loc2_.borderalpha == undefined?100:_loc2_.borderalpha;
      var _loc4_ = _loc2_.backgroundalpha == undefined?100:_loc2_.backgroundalpha;
      var _loc5_ = _loc2_.foregroundalpha == undefined?100:_loc2_.foregroundalpha;
      var _loc6_ = _loc2_.foregroundrotation == undefined?100:_loc2_.foregroundrotation;
      this._mcBorder.clear();
      this._mcBackground.clear();
      this._mcForeground.clear();
      ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcBorder,0,0,1,1,0,_loc2_.bordercolor,_loc3_);
      ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcBackground,0,0,1,1,0,_loc2_.backgroundcolor,_loc4_);
      ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcForeground,0,0,1,1,0,_loc2_.foregroundcolor,_loc5_,_loc6_);
   }
   function drawItem(i, index, nY)
   {
      ...
      if(i.bEnabled)
      {
         ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4_.bg,0,0,1,_loc6_,0,this.getStyle().itembgcolor);
         ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4_.bg,0,0,1,1,0,16777215);
         ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4_.bg,0,_loc6_ - 1,1,1,0,16777215);
         _loc4_.bg._alpha = this.getStyle().itembgalpha == undefined?100:this.getStyle().itembgalpha;
         ...
         {
            this._alpha = this._parent._parent._parent.getStyle().itemoveralpha == undefined?100:this._parent._parent._parent.getStyle().itemoveralpha;
         ...
         {
            this._alpha = this._parent._parent._parent.getStyle().itembgalpha == undefined?100:this._parent._parent._parent.getStyle().itembgalpha;
            var _loc2_ = new Color(this);
      ...
      else
      {
         if(i.bStatic)
         {
            ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4_.bg,0,0,1,_loc6_,0,this.getStyle().itemstaticbgcolor,100,this.getStyle().itemstaticbgrotation);
            ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4_.bg,0,_loc6_ - 1,1,1,0,16777215);
            if(this.getStyle().titledecorationstyle != undefined)
            {
               _loc4_.createEmptyMovieClip("decor",15);
            }
         }
   ...
   function arrangeItem(nIndex, nWidth)
   {
      ...
      if(_loc4_.decor != undefined)
      {
         ank.gapi.core.UIBasicComponent.drawDecoration(_loc4_.decor,ank.gapi.styles.StylesManager.getStyle(this.getStyle().titledecorationstyle),-2,0,nWidth + 2,_loc4_._height);
         _loc4_.bg.decor._y = _loc4_.decor._y - 1;
      }
   }
