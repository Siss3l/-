class ank.gapi.controls.ProgressBar extends ank.gapi.core.UIBasicComponent
{
   ...
   function draw()
   {
      ...
      for(var k in _loc2_)
      {
         ...
         ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2_[k],_loc3_[_loc4_ + "color"]);
      }
      _loc2_ = this._mcRenderer._mcBgMiddle;
      for(var k in _loc2_)
      {
         var _loc5_ = k.split("_")[0];
         ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2_[k],_loc3_[_loc5_ + "color"]);
      }
      _loc2_ = this._mcRenderer._mcBgRight;
      for(var k in _loc2_)
      {
         var _loc6_ = k.split("_")[0];
         ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2_[k],_loc3_[_loc6_ + "color"]);
      }
      _loc2_ = this._mcRenderer._mcUpLeft;
      for(var k in _loc2_)
      {
         var _loc7_ = k.split("_")[0];
         ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2_[k],_loc3_[_loc7_ + "color"]);
      }
      _loc2_ = this._mcRenderer._mcUpMiddle;
      for(var k in _loc2_)
      {
         var _loc8_ = k.split("_")[0];
         ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2_[k],_loc3_[_loc8_ + "color"]);
      }
      _loc2_ = this._mcRenderer._mcUpRight;
      for(var k in _loc2_)
      {
         var _loc9_ = k.split("_")[0];
         ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2_[k],_loc3_[_loc9_ + "color"]);
      }
   }
