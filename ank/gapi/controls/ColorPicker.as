class ank.gapi.controls.ColorPicker extends ank.gapi.core.UIBasicComponent
{
   ...
   function draw()
   {
      ...
      ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcSlider,0,0,1,0.5,0,16777215);
      ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcSlider,0,0.5,1,0.5,0,0);
