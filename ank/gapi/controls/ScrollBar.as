class ank.gapi.controls.ScrollBar extends ank.gapi.core.UIBasicComponent
{
   ...
   function createChildren()
   {
      ...
      _loc2_.up_mc._visible = true;
      _loc2_.over_mc._visible = false;
      _loc2_.down_mc._visible = false;
      _loc3_.up_mc._visible = true;
      _loc3_.over_mc._visible = false;
      _loc3_.down_mc._visible = false;
      _loc4_.up_mc._visible = true;
      _loc4_.over_mc._visible = false;
      _loc4_.down_mc._visible = false;
      _loc5_.up_mc._visible = true;
      _loc5_.over_mc._visible = false;
      _loc5_.down_mc._visible = false;
   ...
   function draw()
   {
      ...
      ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3_.up_mc.bg_mc,_loc2_.sbarrowbgcolor,_loc2_.sbarrowbgalpha);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3_.up_mc.arrow_mc,_loc2_.sbarrowcolor,_loc2_.sbarrowalpha);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3_.down_mc.bg_mc,_loc2_.sbarrowbgcolor,_loc2_.sbarrowbgalpha);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3_.down_mc.arrow_mc,_loc2_.sbarrowcolor,_loc2_.sbarrowalpha);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3_.over_mc.bg_mc,_loc2_.sbarrowbgcolor,_loc2_.sbarrowbgalpha);
      ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3_.over_mc.arrow_mc,_loc2_.sbarrowcolor,_loc2_.sbarrowalpha);
      ...
      {
         ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcHolder.thumb_mc[k],_loc2_.sbthumbcolor,_loc2_.sbthumbalpha);
      }
      ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcHolder.track_mc,_loc2_.sbtrackcolor,_loc2_.sbtrackalpha);
   }
   function size()
   {
      super.size();
