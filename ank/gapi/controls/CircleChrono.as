class ank.gapi.controls.CircleChrono extends ank.gapi.core.UIBasicComponent
{
   ...
   function draw()
   {
      ...
      {
         ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcLeft.bg_mc,_loc2_.bgcolor);
         ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcRight.bg_mc,_loc2_.bgcolor);
      }
   }
