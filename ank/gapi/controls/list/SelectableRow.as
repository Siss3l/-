class ank.gapi.controls.list.SelectableRow extends ank.gapi.core.UIBasicComponent
{
   ...
   function draw()
   {
      ...
      var _loc4_ = _loc2_.cellbgalpha == undefined?_loc3_ != -1?100:0:_loc2_.cellbgalpha;
      var _loc5_ = _loc2_.cellselectedcolor;
      var _loc6_ = _loc2_.cellselectedalpha == undefined?_loc5_ != -1?100:0:_loc2_.cellselectedalpha;
      var _loc7_ = _loc2_.cellovercolor;
      var _loc8_ = _loc2_.celloveralpha == undefined?_loc7_ != -1?100:0:_loc2_.celloveralpha;
      this.over_mc.clear();
      this.selected_mc.clear();
      this.bg_mc.clear();
      ank.gapi.core.UIBasicComponent.drawRoundRect(this.over_mc,0,0,1,1,0,_loc7_,_loc8_);
      ank.gapi.core.UIBasicComponent.drawRoundRect(this.selected_mc,0,0,1,1,0,_loc5_,_loc6_);
      ank.gapi.core.UIBasicComponent.drawRoundRect(this.bg_mc,0,0,1,1,0,typeof _loc3_ != "object"?Number(_loc3_):Number(_loc3_[this._nIndex % _loc3_.length]),_loc4_);
