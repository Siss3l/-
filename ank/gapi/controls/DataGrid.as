class ank.gapi.controls.DataGrid extends ank.gapi.core.UIBasicComponent
{
   ...
   function arrange()
   {
      ...
      while(_loc3_ < this._aColumnsWidths.length)
      {
         ...
         {
            _loc6_._tText._x = this.getStyle().titlelabelxoffset;
         }
         if(this.getStyle().titlelabelyoffset != undefined)
         {
            _loc6_._tText._y = this.getStyle().titlelabelyoffset;
         }
   ...
   function draw()
   {
      ...
      this._mcTitle.clear();
      ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcTitle,0,0,this.__width,this._nTitleHeight,_loc2_.titlecornerradius,_loc2_.titlebgcolor,_loc2_.titlebgalpha,_loc2_.titlerotation);
      this._mcTitle._alpha = _loc2_.titlebgcolor != -1?100:0;
      if(_loc2_.titledecorationstyle != undefined)
      {
         ank.gapi.core.UIBasicComponent.drawDecoration(this._mcTitle,ank.gapi.styles.StylesManager.getStyle(_loc2_.titledecorationstyle),0,0,this.__width,this._nTitleHeight);
      }
   }
   function setLabels()
   {
