class ank.gapi.controls.VolumeSlider extends ank.gapi.core.UIBasicComponent
{
   ...
   function createMarkers()
   {
      ...
      while(_loc2_ < this._nMarkerCount)
      {
         ...
         ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4_,0,0,1,1,0,16711935,0);
         _loc4_.index = _loc2_;
         ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3_,this.getStyle().offcolor);
   ...
   function setValueByIndex(nIndex)
   {
      ...
      while(_loc5_ <= nIndex)
      {
         ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcMarkers["mcMarker" + _loc5_],_loc3_);
         _loc5_ = _loc5_ + 1;
      }
      var _loc6_ = nIndex + 1;
      while(_loc6_ < this._nMarkerCount)
      {
         ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcMarkers["mcMarker" + _loc6_],_loc4_);
         _loc6_ = _loc6_ + 1;
      }
   }
