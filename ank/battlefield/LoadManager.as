class ank.battlefield.LoadManager extends MovieClip
{
   ...
   function processLoad()
   {
      ...
      while(_loc2_ < ank.battlefield.LoadManager._aMovieClipLoader.length)
      {
         ...
         {
            com.ankamagames.tools.Logger.out("processLoad " + ank.battlefield.LoadManager._aMovieClipLoader[_loc2_].file,"ank.battlefield.LoadManager::processLoad","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/LoadManager.as",49);
   ...
   function loadFile(sFile)
   {
      ...
      else
      {
         ...
         com.ankamagames.tools.Logger.out("Load : " + sFile,"ank.battlefield.LoadManager::loadFile","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/LoadManager.as",122);
   ...
   function onLoadError(mc)
   {
      ...
      com.ankamagames.tools.Logger.out("onLoadError " + _loc3_.file,"ank.battlefield.LoadManager::onLoadError","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/LoadManager.as",234);
