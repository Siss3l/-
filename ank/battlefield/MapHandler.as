class ank.battlefield.MapHandler
{
   ...
   function updateCell(nCellNum, oNewCell, sMaskHex, nPermanentLevel)
   {
      ...
      if(nCellNum == 65)
      {
         com.ankamagames.tools.Logger.out("[wtf]Kam Cellule 65. Mask : " + _loc6_,"ank.battlefield.MapHandler::updateCell","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/MapHandler.as",608);
      }
   ...
   function setObject2Frame(nCellNum, frame, hide)
   {
      ...
      if(ank.battlefield.Constants.USE_STREAMING_FILES && (ank.battlefield.Constants.STREAMING_METHOD == "explod" && !_loc6_.fullLoaded))
      {
      ...
      else if(ank.battlefield.Constants.USE_STREAMING_FILES && ank.battlefield.Constants.STREAMING_METHOD == "explod")
      {
         for(var s in _loc6_)
         {
            ...
            {
               _loc6_[s].gotoAndStop(frame);
            }
         }
      }
      else
      {
         _loc6_.gotoAndStop(frame);
      }
   }
   ...
   function resetEmptyCells()
   {
      ...
      if(_loc5_ > 0)
      {
         com.ankamagames.tools.Logger.out("[resetEmptyCells] " + _loc5_ + " dead cells cleaned...","ank.battlefield.MapHandler::resetEmptyCells","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/MapHandler.as",878);
      }
   }
