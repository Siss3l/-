class ank.battlefield.Battlefield extends MovieClip
{
   ...
   function setObject2Frame(nCellNum, frame, hide)
   {
      if(!this.isMapBuild)
      {
         return undefined;
   ...
   function addSprite(sID, spriteData)
   {
      ...
      com.ankamagames.tools.Logger.out("WG Battlefield.as:644 addSprite","ank.battlefield.Battlefield::addSprite","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/Battlefield.as",644);
   ...
   function addCountdownOverHead(oSprite)
   {
      var _loc3_ = oSprite.EffectsManager.getEffects();
      var _loc4_ = new Array();
      var _loc5_ = 0;
      while(_loc5_ < _loc3_.length)
      {
         if(_loc3_[_loc5_].type == 141)
         {
      ...
      if(_loc4_.length > 0)
      {
         this.addSpriteOverHeadItem(oSprite.id,"countdown",dofus.graphics.battlefield.CountdownOverHead,[_loc4_]);
      }
   }
   function removeCountdownOverHead(oSprite)
   {
   ...
   function drawGrid(bAll)
   {
      ...
      {
         com.ankamagames.tools.Logger.out("Dessin de la grille","ank.battlefield.Battlefield::drawGrid","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/Battlefield.as",1099);
