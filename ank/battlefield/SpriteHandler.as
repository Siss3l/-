class ank.battlefield.SpriteHandler
{
   ...
   function addSprite(sID, oSprite)
   {
      ...
      com.ankamagames.tools.Logger.out("WG SpriteHandler.as:121 SpriteHandler.addSprite OK","ank.battlefield.SpriteHandler::addSprite","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/SpriteHandler.as",121);
   }
   ...
   function slideSprite(sID, cellNum, seq, sAnimation)
   {
      ...
      if(_loc8_ != undefined)
      {
         this.moveSprite(sID,_loc8_,seq,false,sAnimation,false);
      }
   }
