class ank.battlefield.datacenter.Sprite extends Object
{
   ...
   function __get__gfxScale()
   {
      return this._nGfxScale;
   }
   function __set__gfxScale(nGfxScale)
   {
      this._nGfxScale = nGfxScale;
      return this.__get__gfxScale();
   }
   ...
   function __get__color4()
   {
      return this._nColor4;
   }
   function __set__color4(value)
   {
      this._nColor4 = Number(value);
      return this.__get__color4();
   }
