class ank.battlefield.mc.Container extends MovieClip
{
   ...
   function clear(bForceReload)
   {
      ...
      if(this.ExternalContainer == undefined || bForceReload)
      {
         ...
         com.ankamagames.tools.Logger.out("LOAD " + this._sObjectsFile,"ank.battlefield.mc.Container::clear","E:\\My_Work\\WLG1\\wakfugardiens\\client\\AnkCommon\\classes/ank/battlefield/mc/Container.as",89);
   ...
   function resetExternalContainer()
   {
   ...
   function getZoomFactor(Void)
   {
      ...
      var _loc5_ = 0;
      if(_loc3_ == ank.battlefield.Constants.DEFAULT_MAP_WIDTH && _loc4_ == ank.battlefield.Constants.DEFAULT_MAP_HEIGHT)
      {
         return 100;
      }
      var _loc6_ = this._mcBattlefield.screenWidth / (ank.battlefield.Constants.CELL_WIDTH * (_loc3_ - 1)) * 100;
      var _loc7_ = this._mcBattlefield.screenHeight / (ank.battlefield.Constants.CELL_HEIGHT * (_loc4_ - 1)) * 100;
